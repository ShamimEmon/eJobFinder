<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Pages/Top_level.Master" CodeBehind="SearchJodDescription.aspx.cs" Inherits="BdJobPortalFinal.Pages.SearchJodDescription" %>
...
<link rel="stylesheet" href="../Css/job_add_style.css" />
    ...
    <div class="job_add_div">
       ...
       <p class="tag">Job Nature</p>
        ...
        <p class="tag">Age Range</p><p class="desc"><%=add.AgeFrom+" years To "+add.AgeTo+" years" %></p>
        <p class="tag">Experience</p><p class="desc"><%=add.Min_exp+" years To "+add.Max_exp+" years"%></p>
        <p class="tag">Gender</p><p class="desc"><%=add.GenderPreference %></p>
         <p class="tag">Location</p><p class="desc"><%=add.Location%></p>
        

        <p class="tag">Salary</p><p class="desc"><%=Convert.ToString(add.Sal)+" BDT To "+Convert.ToString(add.SalMax)+" BDT" %></p>
