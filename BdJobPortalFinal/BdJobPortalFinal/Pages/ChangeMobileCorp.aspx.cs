...
{
    public partial class ChangeMobileCorp : System.Web.UI.Page,IClientSiteHandler,ICompanyInfoUpdator
    {
        private Mobile mob = new Mobile();
        private MobileUpdatorCorporate updator = new MobileUpdatorCorporate();
