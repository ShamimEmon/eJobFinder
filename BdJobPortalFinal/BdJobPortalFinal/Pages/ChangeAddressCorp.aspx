<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Pages/Corporate.Master" CodeBehind="ChangeAddressCorp.aspx.cs" Inherits="BdJobPortalFinal.Pages.ChangeAddressCorp" %>
...
<asp:Content ID="one" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="update_mob_form"  runat="server" class="update_form">
     <p class="tag">Current Address</p><input type="text" runat="server" id="current_address" class="current"/>
     <p class="tag">New Address</p><input type="text" runat="server" id="new_address" class="current"/>
     <p class="tag">Re:new Address</p><input type="text" runat="server" id="re_address" class="current"/>
